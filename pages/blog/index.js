...
export default function Blog({ posts }) {
  ...
  return (
    <>
      <Head>
        <title>Blog | Keerthana Govindaraj</title>
        <meta name="description" content="Blog posts by Keerthana Govindaraj" />
      </Head>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-indigo-100 max-w-2xl mx-auto">
                Thoughts, ideas, and insights on chemistry, electrochemistry, and scientific research.
              </p>
              {isAdmin && (
                <div className="mt-6">
                  <Link href="/blog/new" className="inline-block bg-white text-indigo-600 hover:bg-indigo-50 px-6 py-3 rounded-md text-lg font-medium shadow-lg transition-all">
                    Create New Post
                  </Link>
                </div>
              )}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            {posts.length > 0 ? (
                  ...
                  <div key={post.slug} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    {isAdmin && (
                      <div className="px-6 py-3 bg-gray-100 border-t border-gray-200 flex justify-end space-x-2">
                        <Link href={`/blog/edit/${post.slug}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                          Edit
                        </Link>
              ...
              <div className="text-center py-12">
                ...
                {isAdmin && (
                  <Link href="/blog/new" className="mt-4 inline-block text-indigo-600 hover:text-indigo-800 font-medium">
